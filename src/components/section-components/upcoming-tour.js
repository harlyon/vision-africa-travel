            ...
            <div className="col-lg-4">
              <div className="section-title">
                ...
                <p>
                  ...
                  eros. Sed pretium sem libero, vel pellentesque purus ultrices
                  ut.
                </p>
              </div>
              <div className="row">
              ...
              <div className="upcomming-card-slider upcomming-card-slider-2 tp-common-slider-style">
                <div className="single-upconing-card">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url(" + publicUrl + "assets/img/tour/8.png)",
                    }}
                  >
                  ...
                  <div className="details">
                    <h3 className="title">
                      <Link to="/tour-details">Rome</Link>
                    </h3>
                    <p>
                ...
                <div className="single-upconing-card">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url(" + publicUrl + "assets/img/tour/9.png)",
                    }}
                  >
                  ...
                  <div className="details">
                    <h3 className="title">
                      <Link to="/tour-details">Great Barrier</Link>
                    </h3>
                    <p>
                ...
                <div className="single-upconing-card">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url(" + publicUrl + "assets/img/tour/3.png)",
                    }}
                  >
                  ...
                  <div className="details">
                    <h3 className="title">
                      <Link to="/tour-details">Barrier Reef</Link>
                    </h3>
                    <p>
                ...
                <div className="single-upconing-card">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url(" + publicUrl + "assets/img/tour/7.png)",
                    }}
                  >
                  ...
                  <div className="details">
                    <h3 className="title">
                      <Link to="/tour-details">Machu Picchu</Link>
                    </h3>
                    <p>
                      <i className="fa fa-map-marker" /> Peru
                    </p>

              ...
              <div className="single-destination-grid style-two">
                ...
                <div className="details">
                  <ul className="d-list-meta">
                    ...
                    <li>
                      <img
                        src={publicUrl + "assets/img/icons/13.png"}
                        alt="img"
                      />{" "}
                      550+ Tour Complite
                    </li>
                  ...
                  <h3 className="title">
                    <Link to="/destination-details">
                      The Best Travel Places In The World 2019
                    </Link>
                  </h3>
                  <p className="content">
                    ...
                    6% Earth's total suyface area and 20% land area.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="single-destination-grid style-two">
                ...
                <div className="details">
                  ...
                  <h3 className="title">
                    <Link to="/destination-details">
                      The Best Travel Places In The World 2018
                    </Link>
                  </h3>
                  <p className="content">
                    Africa is the world's second largest and second most-
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-destination-grid style-two">
                ...
                <div className="details">
                  ...
                  <h3 className="title">
                    <Link to="/destination-details">
                      The Best Travel Places In The World 2017
                    </Link>
                  </h3>
                  <p className="content">
                    Africa is the world's second largest and second most-

          ...
          <div className="row">
            <div className="col-xl-3 col-sm-6">
              ...
              >
                <div className="thumb">
                  <img
                    src={publicUrl + "assets/img/destination-list/28.png"}
                    alt="img"
                  />
                </div>
            ...
            <div className="col-xl-3 col-sm-6">
              ...
              >
                <div className="thumb">
                  <img
                    src={publicUrl + "assets/img/destination-list/29.png"}
                    alt="img"
                  />
                </div>
                <div className="details">
            ...
            <div className="col-xl-3 col-sm-6">
              ...
              >
                <div className="thumb">
                  <img
                    src={publicUrl + "assets/img/destination-list/30.png"}
                    alt="img"
                  />
                </div>
                <div className="details">
            ...
            <div className="col-xl-3 col-sm-6">
              ...
              >
                <div className="thumb">
                  <img
                    src={publicUrl + "assets/img/destination-list/31.png"}
                    alt="img"
                  />
                </div>
                <div className="details">
